...
function Pro (apiKey) {
  this.version = 'pro'
  this.apiKey = apiKey
  this.httpUri = 'https://' + this.version + '.rajaongkir.com/api'
  this.couriers = {
    JNE: 'jne',
    TIKI: 'tiki',
    POS: 'pos',
...
Pro.prototype.getCities = function (params) {
...
Pro.prototype.getSubDistrict = function () {
  var uri = this.httpUri + '/subdistrict'
  var apiKey = this.apiKey
  return new Promise(function (resolve, reject) {
    request({
      uri: uri,
...
Pro.prototype.getSubDistrictID = function (id) {
...
Pro.prototype.getSubDistrictCity = function (city) {
  var uri = this.httpUri + '/subdistrict?city=' + city
  var apiKey = this.apiKey
  return new Promise(function (resolve, reject) {
    request({
      uri: uri,
...
Pro.prototype.getInterCost = function (params) {
...
// Pro.prototype.getTIKIInterCost = function (params) {
//   var uri = this.httpUri + '/v2/internationalCost'
//   var apiKey = this.apiKey
//   params.courier = this.couriers.TIKI
//   return new Promise(function (resolve, reject) {
...
Pro.prototype.getWaybill = function (params) {
