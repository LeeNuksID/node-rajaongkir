      ...
      describe('API Key exist', function () {
        ...
        describe('Get Specific Subdistrict by ID', function () {
          it('Should Return Specific Subdistrict', function () {
            ...
            return RajaOngkir.getSubDistrictID(param).then(function (result) {
              result.should.have.property('rajaongkir')
              result.rajaongkir.status.code.should.deep.equal(200)
              result.rajaongkir.status.description.should.deep.equal('OK')
            })
        ...
        describe('Get Specific Subdistrict by Subdistrict ID', function () {
          it('Should Return Specific Subdistrict ID', function () {
            var id = 1
            return RajaOngkir.getSubDistrictID(id).then(function (result) {
              result.should.have.property('rajaongkir')
              result.rajaongkir.status.code.should.deep.equal(200)
              result.rajaongkir.status.description.should.deep.equal('OK')
            })
        ...
        describe('Get Specific Subdistrict by City ID', function () {
          it('Should Return Specific Subdistrict by City ID', function () {
            var city = 1
            return RajaOngkir.getSubDistrictCity(city).then(function (result) {
              result.should.have.property('rajaongkir')
              result.rajaongkir.status.code.should.deep.equal(200)
              result.rajaongkir.status.description.should.deep.equal('OK')
            })
